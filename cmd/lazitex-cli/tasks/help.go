...
func ShowHelp() {
	...
	fmt.Printf("  %-75s %s\n", "-m, --llm link|unlink <model/id/name> | test <model/id/name> | list | [add|remove <model/id/name>] (开发中)", lang.T("help.llm"))
...
func ShowREPLHelp() {
	...
	fmt.Printf("  %-75s - %s\n", "llm link|unlink <model/id/name> | test <model/id/name> | list | [add|remove <model/id/name>] (开发中)", lang.T("repl.llm_desc"))
