...
func ShowHelp() {
	...
	fmt.Printf("  %-100s %s\n", "-m, --llm add <model> -p <provider> -n <name> | remove/link/unlink/test <id/name/model> | list", lang.T("help.llm"))
...
func ShowREPLHelp() {
	...
	fmt.Printf("  %-100s - %s\n", "llm add <model> -p <provider> -n <name> | remove/link/unlink/test <id/name/model> | list", lang.T("repl.llm_desc"))
