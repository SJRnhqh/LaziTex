...
func init() {
	...
	i18n.Register(LangZH, map[string]string{
		...
		"msg.build_usage":        "用法: lazitex -b <文件名.tex> [-o 输出路径] [-s] [-q]",
		...
		"repl.build_usage":      "用法: build <文件名.tex> [-o 输出路径] [-s] [-q]",
	...
	i18n.Register(LangEN, map[string]string{
		...
		"msg.build_usage":        "Usage: lazitex -b <file.tex> [-o output_path] [-s] [-q]",
		...
		"repl.build_usage":      "Usage: build <filename.tex> [-o output_path] [-s] [-q]",
