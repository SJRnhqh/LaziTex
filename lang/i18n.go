...
func init() {
	...
	i18n.Register(LangZH, map[string]string{
		...
		"msg.preview_usage":      "用法: lazitex -p <文件名.tex> [-q|--quiet] [-t|--tidy] [:端口号]",
		...
		"msg.ollama_usage":                          "用法: lazitex -o <-c|--check|-i|--install|-u|--uninstall>",
		...
		"help.live_preview":    "一键实时预览 PDF 文档 (使用 -p 指定文件名，-q 静默模式，-t 清理辅助文件，:端口号 指定端口)",
		...
		"repl.ollama_check_desc":     "检查 Ollama 是否安装",
		"repl.ollama_install_desc":   "安装 Ollama",
		"repl.ollama_uninstall_desc": "卸载 Ollama",
		"repl.ollama_usage":          "用法: ollama <check|-c|install|-i|uninstall|-u>",
		"repl.build_desc":            "构建 LaTeX 文档 (使用 -o 指定输出， -s 编译后展示， -q 静默模式， -t 清理辅助文件)",
		"repl.build_usage":           "用法: build <文件名.tex> [-o|--output 输出路径] [-s|--show] [-q|--quiet] [-t|--tidy]",
		"repl.preview_desc":          "实时预览 PDF 文档 (使用 -q 静默模式，-t 清理辅助文件，:端口号 指定端口)",
		"repl.preview_usage":         "用法: preview <文件名.tex> [-q|--quiet] [-t|--tidy] [:端口号]",
	...
	i18n.Register(LangEN, map[string]string{
		...
		"msg.preview_usage":      "Usage: lazitex -p <file.tex> [-q|--quiet] [-t|--tidy] [:port]",
		...
		"msg.ollama_usage":                          "Usage: lazitex -o <-c|--check|-i|--install|-u|--uninstall>",
		...
		"help.live_preview":    "Live preview PDF document (use -p for file name, -q for quiet mode, -t for tidy mode, :port for custom port)",
		...
		"repl.ollama_check_desc":     "Check if Ollama is installed",
		"repl.ollama_install_desc":   "Install Ollama",
		"repl.ollama_uninstall_desc": "Uninstall Ollama",
		"repl.ollama_usage":          "Usage: ollama <check|-c|install|-i|uninstall|-u>",
		...
		"repl.preview_desc":          "Live preview PDF document (use -q for quiet mode, -t for tidy mode, :port for custom port)",
		"repl.preview_usage":         "Usage: preview <filename.tex> [-q|--quiet] [-t|--tidy] [:port]",
