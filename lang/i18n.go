...
func init() {
	...
	i18n.Register(LangZH, map[string]string{
		...
		"msg.ollama.err_no_action":                  "❌ 错误: 未指定操作",
		"msg.ollama.err_multi_actions":              "❌ 错误: 指定了多个操作（只能选择一个）",
		"msg.ollama.err_unknown_flag":               "❌ 错误: 未知的标志",
		...
		"repl.ollama_check_desc":        "检查 Ollama",
		...
		"repl.ollama.err_no_action":     "❌ 错误: 未指定操作",
		"repl.ollama.err_multi_actions": "❌ 错误: 指定了多个操作（只能选择一个）",
		"repl.ollama.err_unknown_flag":  "❌ 错误: 未知的标志",
	...
	i18n.Register(LangEN, map[string]string{
		...
		"repl.ollama.err_no_action":     "❌ Error: No action specified",
		"repl.ollama.err_multi_actions": "❌ Error: Multiple actions specified (only one allowed)",
		"repl.ollama.err_unknown_flag":  "❌ Error: Unknown flag",
