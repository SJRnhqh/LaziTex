...
func init() {
	...
	i18n.Register(LangZH, map[string]string{
		...
		"msg.llm.test.available_unregistered":          "✅ 可用: %s (ollama:%s) - 未注册，仅测试连通性",
		"msg.llm.test.unavailable_unregistered":        "❌ 不可用: %s (ollama:%s)",
	...
	i18n.Register(LangEN, map[string]string{
		...
		// Test
		"msg.llm.test.read_failed":                     "❌ Failed to read: %v",
		"msg.llm.test.test_failed":                     "❌ Test failed: %v",
		"msg.llm.test.not_found":                       "❌ LLM '%s' not found",
		"msg.llm.test.available_unregistered":          "✅ Available: %s (ollama:%s) - Unregistered, connectivity test only",
		"msg.llm.test.unavailable_unregistered":        "❌ Unavailable: %s (ollama:%s)",
