...
func init() {
	...
	i18n.Register(LangZH, map[string]string{
		...
		// 聊天
		"msg.llm.chat.get_current_failed":   "❌ 获取当前 LLM 失败: %v",
		"msg.llm.chat.no_current_llm":       "❌ 当前没有激活的 LLM",
		"msg.llm.chat.create_model_failed":  "❌ 创建模型失败: %v",
		"msg.llm.chat.unsupported_provider": "❌ 不支持的 LLM 提供程序: %s",
		"msg.llm.chat.welcome":              "💬 Chat 模式已启动",
		"msg.llm.chat.exit_hint":            "💡 输入 'quit'、'exit' 或 'q' 退出",
		"msg.llm.chat.user_prompt":          "\nYou: ",
		"msg.llm.chat.ai_prompt":            "AI: ",
		"msg.llm.chat.goodbye":              "👋 退出 Chat 模式",
		"msg.llm.chat.format_failed":        "❌ 格式化消息失败: %v",
		"msg.llm.chat.stream_failed":        "❌ 调用模型失败: %v",
		"msg.llm.chat.timeout":              "❌ 请求超时，请稍后重试",
		"msg.llm.chat.receive_error":        "❌ 接收响应时出错: %v",
		"msg.llm.chat.system_message":       "你要用中文回答问题。",
		// 客户端
		"msg.llm.client.create_failed":        "❌ 创建 ChatModel 客户端失败",
		"msg.llm.client.unsupported_provider": "❌ 不支持的 LLM 提供程序: %s",
		// 测试
		...
		"msg.llm.test.update_config_failed":            "⚠️  更新配置失败: %v",
		...
		"msg.llm.test.model_multiple_title":            "模型 '%s' 匹配到多个 LLM Provider",
		"msg.llm.test.registered_title":                "已注册的 LLM Provider",
		"msg.llm.test.no_providers":                    "当前没有已注册的 LLM Provider",
		"msg.llm.test.unsupported_provider":            "❌ 不支持的 Provider 类型: %s",
		"msg.llm.test.select_prompt":                   "请选择要测试的 Provider：",
		"msg.llm.test.select_number":                   "  - 输入数字 (1-%d) 选择特定 LLM 并测试",
		"msg.llm.test.select_all":                      "  - 输入 'a' 或 'all' 全部测试",
		"msg.llm.test.select_cancel":                   "  - 输入 'q' 或 'quit' 取消",
		"msg.llm.test.select_input":                    "选择: ",
		"msg.llm.test.test_all_count":                  "共测试 %d 个 Provider，成功 %d 个",
		// 连接
		...
		"msg.llm.link.batch_multiple_skip":    "⚠️ %s 匹配到多个 Provider，跳过批量模式下的歧义项",
		...
		"msg.llm.unlink.batch_multiple_skip":  "⚠️ %s 匹配到多个 Provider，跳过批量模式下的歧义项",
		...
		"msg.llm.remove.failed":               "❌ 删除失败: %s - %v",
		...
		"msg.llm.remove.model_multiple_title": "模型 '%s' 匹配到多个 LLM Provider",
		"msg.llm.remove.registered_title":     "已注册的 LLM Provider",
		"msg.llm.remove.no_providers":         "当前没有已注册的 LLM Provider",
		"msg.llm.remove.confirm_prompt":       "确定要删除该 LLM Provider 吗？",
		"msg.llm.remove.provider_info":        "Provider 信息: %s (类型: %s, 模型: %s)",
		"msg.llm.remove.warning_current":      "⚠️  警告: 该 Provider 是当前前台 LLM，删除后将清空前台状态",
		"msg.llm.remove.warning_active":       "⚠️  警告: 该 Provider 已激活，删除后将自动取消激活",
		"msg.llm.remove.select_prompt":        "请选择要删除的 Provider：",
		"msg.llm.remove.select_number":        "  - 输入数字 (1-%d) 选择特定 LLM 并删除",
		"msg.llm.remove.select_all":           "  - 输入 'a' 或 'all' 全部删除",
		"msg.llm.remove.select_cancel":        "  - 输入 'q' 或 'quit' 取消",
		"msg.llm.remove.select_input":         "选择: ",
		"msg.llm.remove.batch_no_matches":     "❌ 没有找到任何匹配的 Provider",
		"msg.llm.remove.batch_list":           "将要删除以下 %d 个 Provider：",
		"msg.llm.remove.batch_confirm":        "确定要删除这 %d 个 LLM Provider 吗？",
		"msg.llm.remove.batch_success":        "✅ 成功删除 %d/%d 个 Provider",
		// 通用选择提示
		...
		"repl.llm":              "LLM 管理【开发中】",
		"repl.llm_usage":        "用法: llm link|unlink|test|remove|list [name...] | llm switch [name] | llm ask <msg> | llm chat",
	...
	i18n.Register(LangEN, map[string]string{
		...
		// Chat
		"msg.llm.chat.get_current_failed":   "❌ Failed to get current LLM: %v",
		"msg.llm.chat.no_current_llm":       "❌ No active LLM currently",
		"msg.llm.chat.create_model_failed":  "❌ Failed to create model: %v",
		"msg.llm.chat.unsupported_provider": "❌ Unsupported LLM provider: %s",
		"msg.llm.chat.welcome":              "💬 Chat mode started",
		"msg.llm.chat.exit_hint":            "💡 Type 'quit', 'exit' or 'q' to exit",
		"msg.llm.chat.user_prompt":          "\nYou: ",
		"msg.llm.chat.ai_prompt":            "AI: ",
		"msg.llm.chat.goodbye":              "👋 Exiting chat mode",
		"msg.llm.chat.format_failed":        "❌ Failed to format messages: %v",
		"msg.llm.chat.stream_failed":        "❌ Failed to call model: %v",
		"msg.llm.chat.timeout":              "❌ Request timeout, please try again later",
		"msg.llm.chat.receive_error":        "❌ Error receiving response: %v",
		"msg.llm.chat.system_message":       "You should answer questions in Chinese.",
		// Client
		"msg.llm.client.create_failed":        "❌ Failed to create ChatModel client",
		"msg.llm.client.unsupported_provider": "❌ Unsupported LLM provider: %s",
		// Test
		...
		"msg.llm.test.update_config_failed":            "⚠️  Failed to update config: %v",
		...
		"msg.llm.test.model_multiple_title":            "Model '%s' matches multiple LLM Providers",
		"msg.llm.test.registered_title":                "Registered LLM Providers",
		"msg.llm.test.no_providers":                    "No registered LLM Providers",
		"msg.llm.test.unsupported_provider":            "❌ Unsupported provider type: %s",
		"msg.llm.test.select_prompt":                   "Please select Provider to test:",
		"msg.llm.test.select_number":                   "  - Enter number (1-%d) to select specific LLM and test",
		"msg.llm.test.select_all":                      "  - Enter 'a' or 'all' to test all",
		"msg.llm.test.select_cancel":                   "  - Enter 'q' or 'quit' to cancel",
		"msg.llm.test.select_input":                    "Choice: ",
		"msg.llm.test.test_all_count":                  "Tested %d Providers, %d successful",
		// Connect
		...
		"msg.llm.link.batch_multiple_skip":    "⚠️ %s matches multiple Providers, skipping ambiguous item in batch mode",
		...
		"msg.llm.unlink.batch_multiple_skip":  "⚠️ %s matches multiple Providers, skipping ambiguous item in batch mode",
		...
		"msg.llm.remove.failed":               "❌ Deletion failed: %s - %v",
		...
		"msg.llm.remove.model_multiple_title": "Model '%s' matches multiple LLM Providers",
		"msg.llm.remove.registered_title":     "Registered LLM Providers",
		"msg.llm.remove.no_providers":         "No registered LLM Providers",
		"msg.llm.remove.confirm_prompt":       "Are you sure you want to remove this LLM Provider?",
		"msg.llm.remove.provider_info":        "Provider info: %s (Type: %s, Model: %s)",
		"msg.llm.remove.warning_current":      "⚠️  Warning: This Provider is the current foreground LLM, deletion will clear foreground status",
		"msg.llm.remove.warning_active":       "⚠️  Warning: This Provider is active, deletion will automatically deactivate it",
		"msg.llm.remove.select_prompt":        "Please select Provider to remove:",
		"msg.llm.remove.select_number":        "  - Enter number (1-%d) to select specific LLM and remove",
		"msg.llm.remove.select_all":           "  - Enter 'a' or 'all' to remove all",
		"msg.llm.remove.select_cancel":        "  - Enter 'q' or 'quit' to cancel",
		"msg.llm.remove.select_input":         "Choice: ",
		"msg.llm.remove.batch_no_matches":     "❌ No matching Providers found",
		"msg.llm.remove.batch_list":           "The following %d Providers will be removed:",
		"msg.llm.remove.batch_confirm":        "Are you sure you want to remove these %d LLM Providers?",
		"msg.llm.remove.batch_success":        "✅ Successfully removed %d/%d Providers",
		...
		"repl.llm":              "LLM management[Dev]",
		"repl.llm_usage":        "Usage: llm link|unlink|test|remove|list [name...] | llm switch [name] | llm ask <msg> | llm chat",
