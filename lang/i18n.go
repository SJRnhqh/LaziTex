...
func init() {
	...
	i18n.Register(LangZH, map[string]string{
		...
		"msg.build_usage":        "用法: lazitex -b <文件名.tex> [-o|--output 输出路径] [-s|--show] [-q|--quiet]",
		...
		"repl.build_usage":           "用法: build <文件名.tex> [-o|--output 输出路径] [-s|--show] [-q|--quiet]",
	...
	i18n.Register(LangEN, map[string]string{
		...
		"msg.build_usage":        "Usage: lazitex -b <file.tex> [-o|--output output_path] [-s|--show] [-q|--quiet]",
		...
		"repl.build_usage":           "Usage: build <filename.tex> [-o|--output output_path] [-s|--show] [-q|--quiet]",
