...
func init() {
	...
	i18n.Register(LangZH, map[string]string{
		...
		// CLI 用法
		"msg.llm.cli_usage": "用法: lazitex -m list | lazitex -m add <model> -p <provider> -n <name> | lazitex -m [remove|link|unlink|test] <id/name/model>",
		// Add 命令相关
		...
		"repl.llm_usage":        "用法: llm list | llm add <model> -p <provider> -n <name> | llm [remove|link|unlink|test] <id/name/model>",
	...
	i18n.Register(LangEN, map[string]string{
		...
		// CLI usage
		"msg.llm.cli_usage": "Usage: lazitex -m list | lazitex -m add <model> -p <provider> -n <name> | lazitex -m [remove|link|unlink|test] <id/name/model>",
		// Add command related
		...
		"repl.llm_usage":        "Usage: llm list | llm add <model> -p <provider> -n <name> | llm [remove|link|unlink|test] <id/name/model>",
