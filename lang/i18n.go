...
func init() {
	...
	i18n.Register(LangZH, map[string]string{
		...
		"msg.llm.link.set_current_failed": "⚠️  设置当前 LLM 失败: %v",
		...
		"msg.llm.switch.not_linked":       "⚠️  LLM '%s' 未链接，请先使用 link 命令",
		"msg.llm.switch.failed":           "❌ 切换失败: %v",
		"msg.llm.switch.success":          "✓ 已切换到 LLM: %s (%s)",
		"msg.llm.switch.multiple_matches": "找到 %d 个匹配的 LLM，请选择要切换的：",
		// 删除
	...
	i18n.Register(LangEN, map[string]string{
		...
		"msg.llm.link.set_current_failed": "⚠️  Failed to set current LLM: %v",
		...
		"msg.llm.switch.not_linked":       "⚠️  LLM '%s' is not linked, please use link command first",
		"msg.llm.switch.failed":           "❌ Switch failed: %v",
		"msg.llm.switch.success":          "✓ Switched to LLM: %s (%s)",
		"msg.llm.switch.multiple_matches": "Found %d matching LLMs, please select one to switch:",
		// Remove
