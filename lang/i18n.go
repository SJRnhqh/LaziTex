...
func init() {
	...
	i18n.Register(LangZH, map[string]string{
		...
		"msg.preview_usage":      "用法: lazitex -p <文件名.tex> [-q|--quiet] [-t|--tidy]",
		...
		"help.live_preview":    "一键实时预览 PDF 文档 (使用 -p 指定文件名，-q 静默模式，-t 清理辅助文件)",
		...
		"repl.preview_desc":          "实时预览 PDF 文档 (使用 -q 静默模式，-t 清理辅助文件)",
		"repl.preview_usage":         "用法: preview <文件名.tex> [-q|--quiet] [-t|--tidy]",
	...
	i18n.Register(LangEN, map[string]string{
		...
		"msg.preview_usage":      "Usage: lazitex -p <file.tex> [-q|--quiet] [-t|--tidy]",
		...
		"help.live_preview":    "Live preview PDF document (use -p for file name, -q for quiet mode, -t for tidy mode)",
		...
		"repl.preview_desc":          "Live preview PDF document (use -q for quiet mode, -t for tidy mode)",
		"repl.preview_usage":         "Usage: preview <filename.tex> [-q|--quiet] [-t|--tidy]",
