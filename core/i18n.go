...
func init() {
	...
	i18n.Register(LangZH, map[string]string{
		...
		"msg.build_usage":        "用法: lazitex -b <文件名.tex> [-o 输出路径] [-p]",
		...
		"help.build_latex":     "一键构建 LaTeX 文档为 PDF (使用 -o 指定输出, -p 自动预览)",
		...
		"repl.build_desc":       "构建 LaTeX 文档 (使用 -o 指定输出, -p 自动预览)",
		"repl.build_usage":      "用法: build <文件名.tex> [-o 输出路径] [-p]",
	...
	i18n.Register(LangEN, map[string]string{
		...
		"msg.build_usage":        "Usage: lazitex -b <file.tex> [-o output_path] [-p]",
		...
		"help.build_latex":     "Build LaTeX document to PDF (use -o for output, -p for preview)",
		...
		"repl.build_desc":       "Build LaTeX document (use -o for output, -p for preview)",
		"repl.build_usage":      "Usage: build <filename.tex> [-o output_path] [-p]",
