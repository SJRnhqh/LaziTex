...
func init() {
	...
	i18n.Register(LangZH, map[string]string{
		...
		"help.build_latex":     "一键构建 LaTeX 文档为 PDF (使用 -p 参数自动打开预览PDF)",
		...
		"repl.build_desc":       "构建 LaTeX 文档 (使用 -p 参数自动打开预览PDF)",
		"repl.build_usage":      "用法: build <文件名.tex> [-p]",
	...
	i18n.Register(LangEN, map[string]string{
		...
		"help.build_latex":     "Build LaTeX document to PDF (use -p to automatically open preview PDF)",
		...
		"repl.build_desc":       "Build LaTeX document (use -p to automatically open preview PDF)",
		"repl.build_usage":      "Usage: build <filename.tex> [-p]",
